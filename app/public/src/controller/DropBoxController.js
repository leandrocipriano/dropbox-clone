class DropBoxController {
    ...
    conectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyB2Swr9sQlBj4vVN_YiUxMZE-b_aG9OUnA",
            authDomain: "dropbox-clone-a45c6.firebaseapp.com",
            databaseURL: "https://dropbox-clone-a45c6.firebaseio.com",
            projectId: "dropbox-clone-a45c6",
            storageBucket: "dropbox-clone-a45c6.appspot.com",
            messagingSenderId: "114125947579",
            appId: "1:114125947579:web:fb16c7f0996664f5a8df9e",
            measurementId: "G-61Q1DXXF56"
        };
        // Initialize Firebase
        ...
        this.getSelection().forEach(li => {
            ...
            promises.push(new Promise((resolve, reject)=>{
                ...
                if(file.type === 'folder'){
                    ...
                    //ao executar uma promessa, precisamos resolvâ-la com o then()
         ...
         this.inputFilesEl.addEventListener('change', event => {
            ...
            this.uploadTask(event.target.files).then(responses => {
                ...
                responses.forEach(resp => {
                    ...
                    //Quando existir um nó com hifén colocar entre chaves e aspas
                    //console.log(resp.files.input-file);
                    //console.log(resp.files['input-file']);

                    //this.getFirebaseRef().push().set(resp.files['input-file']);
                    //console.log('unic resp: ', resp);
                    this.getFirebaseRef().push().set({
                        name:resp.name,
    ...
    ajax(url, method = 'GET', formData = new FormData(), onprogress = function(){}, onloadstart= function(){}){
        ...
        return new Promise((resolve, reject)=> {
            ...
            //console.log(formData.key, formData.file);
    ...
    uploadTask(files){
                ...
                task.on('state_changed', snapshot=>{
                    ...
                    task.snapshot.ref.getDownloadURL().then( downloadURL => {
                        ...
                        task.snapshot.ref.updateMetadata({ 
                            customMetadata: { downloadURL }}).then( metadata => {
                    
                         //console.log(metadata.customMetadata.downloadURL);
                         //file.path = metadata.customMetadata.downloadURL;
                         //file.fullPath = metadata.customMetadata.downloadURL;
                         //console.log('download link: ', file);
                         //upload set information
        ...
        //Saving archives in localstorage
        ...
        li.addEventListener('click', e=>{
            ...
            if(e.shiftKey){
                ...
                if(firstLi) {
                    ...
                    let indexStart;
                    let indexEnd;
                    let listOfLi = li.parentElement.childNodes;

                    listOfLi.forEach((el, index)=>{
